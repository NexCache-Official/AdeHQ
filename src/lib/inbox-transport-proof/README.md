# Inbox Transport Proof (Slice 0) — REMOVABLE

Temporary harness for proving Resend send/receive on `inbox.adehq.com`.

**Not product code.** Safe to delete entirely once Slice A begins:
