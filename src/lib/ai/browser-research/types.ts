...
export const BROWSER_RESEARCH_UI_COPY = {
  ...
  agentModeOnHint: "Fast web search (Tavily) — send your question in chat",
  agentModeOffHint: "Toggle for fast Tavily search on your next message",
  liveAgentModeLabel: "Agent",
  liveAgentModeOnHint: "Live browser agent (Browserbase) — send your question in chat",
  liveAgentModeOffHint: "Toggle for live browser agent mode on your next message",
  watchLiveBrowser: "Watch live browser",
  liveBrowserEmbedTitle: "Live browser session",
  searchingStatus: "Searching the web…",
  liveBrowsingStatus: "Browsing live…",
