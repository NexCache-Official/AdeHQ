...
export const TOOL_CATALOG: Tool[] = [
  ...
  { id: "adehq-calendar", name: "AdeHQ Calendar", category: "Business", description: "Plan campaigns, schedule posts, and manage your content calendar inside AdeHQ.", status: "connected" },
  { id: "adehq-investors", name: "AdeHQ Investors", category: "Fundraising", description: "Investor firms, contacts, and pipeline inside AdeHQ.", status: "connected" },
  ...
  { id: "web-search", name: "Web Search", category: "Research", description: "Search the live web for fresh information and sources.", status: "coming_soon" },
  { id: "browser", name: "Browser", category: "Research", description: "Open and read web pages like a human researcher.", status: "coming_soon" },
  { id: "perplexity", name: "Perplexity", category: "Research", description: "Answer engine for deep, cited research.", status: "coming_soon" },
  { id: "files", name: "Files", category: "Storage", description: "Read and write project files and documents.", status: "coming_soon" },
  ...
  { id: "github", name: "GitHub", category: "Coding", description: "Read repos, open PRs, and manage issues.", status: "coming_soon" },
  { id: "cursor", name: "Cursor", category: "Coding", description: "Pair-program inside the codebase.", status: "coming_soon" },
  { id: "vercel", name: "Vercel", category: "Coding", description: "Deploy previews and inspect production.", status: "coming_soon" },
  { id: "supabase", name: "Supabase", category: "Coding", description: "Query the database and manage schema.", status: "coming_soon" },
  { id: "figma", name: "Figma", category: "Design", description: "Read design files and leave critique.", status: "coming_soon" },
  { id: "notion", name: "Notion", category: "Productivity", description: "Read and write docs, specs, and wikis.", status: "coming_soon" },
  { id: "linear", name: "Linear", category: "Productivity", description: "Create and track issues and cycles.", status: "coming_soon" },
  ...
  { id: "calendar", name: "Google Calendar", category: "Productivity", description: "Sync meetings and events from Google Calendar.", status: "coming_soon" },
  { id: "unity", name: "Unity", category: "Game development", description: "Inspect Unity scenes and assets.", status: "coming_soon" },
  { id: "godot", name: "Godot", category: "Game development", description: "Work with Godot scenes and scripts.", status: "coming_soon" },
  { id: "blender", name: "Blender", category: "Game development", description: "Generate and tweak 3D assets.", status: "coming_soon" },
  { id: "stripe", name: "Stripe", category: "Business", description: "Inspect payments and revenue (with approval).", status: "not_connected" },
  { id: "siliconflow", name: "SiliconFlow", category: "Model providers", description: "DeepSeek, Qwen, Kimi, and more.", status: "coming_soon" },
  { id: "anthropic", name: "Anthropic", category: "Model providers", description: "Claude models for reasoning and writing.", status: "coming_soon" },
  { id: "gemini", name: "Gemini", category: "Model providers", description: "Google multimodal models.", status: "coming_soon" },
];
