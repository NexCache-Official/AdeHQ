...
const NAV_SECTIONS: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/playbook-runs", label: "Playbook Runs", icon: Package },
      { href: "/admin/procedures", label: "Procedures", icon: Layers },
      { href: "/admin/artifact-runtime", label: "Artifact Runtime", icon: FileStack },
