...
-- =============================================================================
-- PR-25 Playbook / Procedure / Artifact Runtime (inlined for greenfield)
-- Source migrations (also applied on linked production):
--   20260723200000_pr25_playbook_artifact_runtime.sql
--   20260723210000_pr25_playbook_runtime_rls_writes.sql
-- Idempotent (IF NOT EXISTS / DROP POLICY IF EXISTS) — safe alongside migrations.
-- =============================================================================
...
-- =============================================================================
-- PR-25 follow-up: live execution RLS writes
-- =============================================================================
