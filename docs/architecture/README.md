...
Living engineering design for systems that are actively evolving in this repo.

| Doc | Topic |
|-----|--------|
| [`workspace-inbox-foundation.md`](./workspace-inbox-foundation.md) | Shared workspace inbox slices (Resend + Supabase) |
