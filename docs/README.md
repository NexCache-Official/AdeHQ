...
|------|-------------------|
| [`architecture/`](./architecture/) | Living system design (inbox foundation, email, intelligence, [AdeHQ Brain](./architecture/adehq-brain.md), [human/hybrid calls](./architecture/human-hybrid-calls.md), known issues) |
